...
public class DictionaryServiceImpl implements IDictionaryService {
    ...
    public Map<String, List<DictDataDTO>> batchFindDictionaryDataByTypes(List<String> types) {
        ...
        // 不存在：feign,
        Map<String, List<com.seekisle.adminapi.config.domain.dto.DictionaryDataDTO>> map =
        ...
        // 缓存结果
        for (Map.Entry<String, List<com.seekisle.adminapi.config.domain.dto.DictionaryDataDTO>> entry : map.entrySet()) {
